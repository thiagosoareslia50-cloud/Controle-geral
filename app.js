...
//
const SUPABASE_URL = typeof process !== 'undefined' && process.env.SUPABASE_URL ? process.env.SUPABASE_URL : (window.ENV ? window.ENV.SUPABASE_URL : "");
const SUPABASE_ANON_KEY = typeof process !== 'undefined' && process.env.SUPABASE_ANON_KEY ? process.env.SUPABASE_ANON_KEY : (window.ENV ? window.ENV.SUPABASE_ANON_KEY : "");
