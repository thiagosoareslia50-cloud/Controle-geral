...
const ST = {
  ...
  async list(prefix) {
    ...
    try {
      const results = [];
      // ⚡ Bolt Optimization: Replace O(N^2) loop localStorage.key(i) with O(N) Object.keys(localStorage)
      // Impact: Significantly reduces JS-to-native boundary crossings, speeding up fallback data loading.
