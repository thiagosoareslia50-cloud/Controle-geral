...
const ST = {
  ...
  async list(prefix) {
    ...
    try {
      const results = [];
      // [Bolt Performance] Use Object.keys(localStorage) instead of index-based iteration with localStorage.key(i)
      // to avoid O(N) internal proxy lookups/boundary crossings on every iteration.
