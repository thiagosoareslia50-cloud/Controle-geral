...
function NovoProcessoPage({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    title: objMode === "historico" ? "Ver todos os objetos" : "Filtrar objetos do histórico",
    "aria-label": objMode === "historico" ? "Ver todos os objetos" : "Filtrar objetos do histórico",
    style: {
      width: 38,
      height: 38,
      flexShrink: 0,
