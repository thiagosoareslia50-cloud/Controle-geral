...
function NovoProcessoPage({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    title: objMode === "historico" ? "Ver todos os objetos" : "Ver objetos do histórico deste fornecedor",
    "aria-label": objMode === "historico" ? "Ver todos os objetos" : "Ver objetos do histórico deste fornecedor",
    style: {
      width: 38,
      height: 38,
      flexShrink: 0,
