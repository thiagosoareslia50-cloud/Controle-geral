...
function App() {
  ...
  }, "Esta a\xE7\xE3o apaga ", /*#__PURE__*/React.createElement("strong", null, "todos os dados do sistema"), ": processos, hist\xF3rico, \xF3rg\xE3os e configura\xE7\xF5es. Esta opera\xE7\xE3o \xE9 irrevers\xEDvel."), !showApagar ? /*#__PURE__*/React.createElement("button", {
    onClick: () => {
      setShowApagar(true);
      setSenhaApagar("");
      setApagarErr("");
