...
async function hashSenha(salt, senha) {
  const e = new TextEncoder();
  // 🛡️ Sentinel: Upgrade from un-iterated SHA-256 to PBKDF2 (100,000 iterations) for secure password hashing
...
async function checkLogin(login, senha) {
  ...
  // 🛡️ Sentinel: Try PBKDF2 first, fall back to legacy un-iterated SHA-256 for backward compatibility
