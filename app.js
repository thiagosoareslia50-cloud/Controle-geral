...
const T = {
  ...
  appBgDark: "linear-gradient(160deg,#00380a 0%,#004010 50%,#00205a 100%)",
  cardBgDark: "#003808",
  borderDark: "#005c1a",
  textMainDark: "#f0fae8",
...
function LoginPage({
  ...
  return /*#__PURE__*/React.createElement("div", {
    style: {
      ...
      alignItems: "center",
      justifyContent: "center",
      background: "linear-gradient(135deg,#003800 0%,#005000 40%,#001a60 100%)"
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      width: 380,
      background: "linear-gradient(160deg,#004500 0%,#003800 100%)",
      borderRadius: 20,
      padding: "40px 36px",
      boxShadow: "0 32px 80px rgba(0,64,0,.5)",
    ...
    style: {
      ...
      border: "1.5px solid rgba(239,209,3,.4)"
    }
...
function Sidebar({
  ...
  const NavItem = ({
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        ...
        cursor: "pointer",
        transition: "all .15s",
        background: active ? "rgba(239,209,3,.18)" : "transparent",
        border: active ? "1px solid rgba(239,209,3,.55)" : "1px solid transparent"
      }
    }, /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: 15,
  ...
  return /*#__PURE__*/React.createElement("div", {
    style: {
      ...
      display: "flex",
      flexDirection: "column",
      background: "linear-gradient(180deg,#004d00 0%,#003800 50%,#002a00 100%)",
      height: "100vh",
      position: "sticky",
      top: 0,
    ...
    style: {
      ...
      borderRadius: 10,
      border: "1px solid rgba(239,209,3,.40)",
      display: "flex",
      justifyContent: "space-between",
      alignItems: "center"
    }
