...
//
const SUPABASE_URL = typeof process !== "undefined" && process.env && process.env.SUPABASE_URL ? process.env.SUPABASE_URL : typeof window !== "undefined" && window.ENV ? window.ENV.SUPABASE_URL : "";
const SUPABASE_ANON_KEY = typeof process !== "undefined" && process.env && process.env.SUPABASE_ANON_KEY ? process.env.SUPABASE_ANON_KEY : typeof window !== "undefined" && window.ENV ? window.ENV.SUPABASE_ANON_KEY : "";
