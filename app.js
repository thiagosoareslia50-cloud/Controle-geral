...
//
const SUPABASE_URL = window.ENV?.SUPABASE_URL || (typeof process !== 'undefined' && process.env && process.env.SUPABASE_URL) || "";
const SUPABASE_ANON_KEY = window.ENV?.SUPABASE_ANON_KEY || (typeof process !== 'undefined' && process.env && process.env.SUPABASE_ANON_KEY) || "";
