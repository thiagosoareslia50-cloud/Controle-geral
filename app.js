...
function NovoProcessoPage({
  ...
  const onOrgChange = val => {
    ...
    setForm(f => ({
      ...f,
      orgao: v,
      secretario: f.secretario || (orgaosConfig[v]?.secretario) || mp.orgaoSecretario[v] || "",
  ...
  const onContratoChange = v => {
    ...
    setForm(f => {
      ...
      return {
        ...
        secretario: (novoOrgao ? (orgaosConfig[novoOrgao]?.secretario) || mp.orgaoSecretario[novoOrgao] || "" : "") || f.secretario
      };
    });
    if (forn || org || meta) {
  ...
  const secSug = form.orgao && !form.secretario ? (orgaosConfig[form.orgao]?.secretario) || mp.orgaoSecretario[form.orgao] || "" : "";
  ...
  const makeDados = () => {
    ...
    const secretario= form.secretario|| (useMap ? (orgaosConfig[org]?.secretario) || mp.orgaoSecretario[org] || "" : "");
